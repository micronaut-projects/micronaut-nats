...
<1> With link:{apinats}{natsVersion}/io/nats/client/PublishOptions.html[PublishOptions] you can define additional options for publishing message with jetstream. You can also retrieve a link:{apinats}{natsVersion}/io/nats/client/api/PublishAck.html[PublishAck] object representing a JetStream enabled server acknowledgment.
