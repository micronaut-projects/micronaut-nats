...
snippet::io.micronaut.nats.docs.consumer.custom.annotation.SIDAnnotationBinder[tags="imports,clazz", indent=0, project-base="docs-examples/example"]
...
snippet::io.micronaut.nats.docs.consumer.custom.type.ProductInfoTypeBinder[tags="imports,clazz", indent=0, project-base="docs-examples/example"]
